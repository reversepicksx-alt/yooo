__d(function (global, require, _$$_IMPORT_DEFAULT, _$$_IMPORT_ALL, module, exports, _dependencyMap) {
  ...
  (function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var UTRIE2_DATA_MASK$1 = 31;
    var UTRIE2_LSCP_INDEX_2_LENGTH$1 = 32;
    /** Count the lengths of both BMP pieces. 2080=0x820 */
    var UTRIE2_INDEX_2_BMP_LENGTH$1 = 2080;
    /**
     ...
     */
    var UTRIE2_INDEX_1_OFFSET$1 = 2112;
    /**
    ...
    var UTRIE2_INDEX_2_BLOCK_LENGTH$1 = 64;
    /** Mask for getting the lower bits for the in-index-2-block offset. */
    var UTRIE2_INDEX_2_MASK$1 = 63;
    ...
    var createTrieFromBase64$1 = function (base64, _byteLength) {
      ...
      var headerLength = 24;
      var index = slice16$1(view16, 12, view32[4] / 2);
      ...
      Trie.prototype.get = function (codePoint) {
        ...
        if (codePoint >= 0) {
          ...
          if (codePoint < this.highStart) {
            ...
            ix = 2080 + (codePoint >> UTRIE2_SHIFT_1$1);
            ix = this.index[ix];
      ...
      Tokenizer.prototype.consumeUrlToken = function () {
        ...
        while (true) {
          ...
          if (codePoint === EOF || codePoint === RIGHT_PARENTHESIS) {
            return {
              type: 22 /* URL_TOKEN */,
              value: fromCodePoint$1.apply(undefined, value)
            };
    ...
    function hue2rgb(t1, t2, hue) {
      ...
      if (hue < 0.16666666666666666) {
        ...
        return (t2 - t1) * 6 * (0.6666666666666666 - hue) + t1;
      } else {
        return t1;
      }
    }
    var hsl = function (context, args) {
      ...
      var t1 = l * 2 - t2;
      var r = hue2rgb(t1, t2, h + 0.3333333333333333);
      var g = hue2rgb(t1, t2, h);
      var b = hue2rgb(t1, t2, h - 0.3333333333333333);
    ...
    var findCorner = function (width, height, x, y, closest) {
      ...
      return corners.reduce(function (stat, corner) {
        ...
        optimumDistance: closest ? Infinity : -(1 / 0),
        optimumCorner: null
      }).optimumCorner;
    };
    ...
    /** Mask for getting the lower bits for the in-data-block offset. */
    var UTRIE2_DATA_MASK = 31;
    var UTRIE2_LSCP_INDEX_2_LENGTH = 32;
    /** Count the lengths of both BMP pieces. 2080=0x820 */
    var UTRIE2_INDEX_2_BMP_LENGTH = 2080;
    /**
     * The 2-byte UTF-8 version of the index-2 table follows at offset 2080=0x820.
     * Length 32=0x20 for lead bytes C0..DF, regardless of UTRIE2_SHIFT_2.
     */
     ...
     * are omitted completely if there is only BMP data.
     */
    var UTRIE2_INDEX_1_OFFSET = 2112;
    /**
     * Number of index-1 entries for the BMP. 32=0x20
     * This part of the index-1 table is omitted from the serialized form.
     */
    ...
    /** Number of entries in an index-2 block. 64=0x40 */
    var UTRIE2_INDEX_2_BLOCK_LENGTH = 64;
    /** Mask for getting the lower bits for the in-index-2-block offset. */
    var UTRIE2_INDEX_2_MASK = 63;
    ...
    var createTrieFromBase64 = function (base64, _byteLength) {
      ...
      var headerLength = 24;
      var index = slice16(view16, 12, view32[4] / 2);
    ...
    var Trie = /** @class */function () {
      ...
      Trie.prototype.get = function (codePoint) {
        ...
        if (codePoint >= 0) {
          ...
          if (codePoint < this.highStart) {
            // Supplemental code point, use two-level lookup.
            ix = 2080 + (codePoint >> UTRIE2_SHIFT_1);
            ix = this.index[ix];
    ...
    var createPseudoHideStyles = function (body) {
      createStyles(body, ".___html2canvas___pseudoelement_before:before{\n    content: \"\" !important;\n    display: none !important;\n}\n         .___html2canvas___pseudoelement_after:after{\n    content: \"\" !important;\n    display: none !important;\n}");
    };
      ...
      function ElementPaint(container, parent) {
        ...
        if (this.container.styles.overflowX !== 0 /* VISIBLE */) {
          ...
          if (equalPath(borderBox, paddingBox)) {
            this.effects.push(new ClipEffect(borderBox, 6 /* CONTENT */));
          } else {
        ...
        while (parent) {
          ...
          if (inFlow || parent.container.styles.position !== 0 /* STATIC */ || !parent.parent) {
            ...
            if (parent.container.styles.overflowX !== 0 /* VISIBLE */) {
              ...
              if (!equalPath(borderBox, paddingBox)) {
                effects.unshift(new ClipEffect(paddingBox, 6 /* CONTENT */));
              }
            }
          } else {
            effects.unshift.apply(effects, croplessEffects);
          ...
          switch (_u.label) {
            case 0:
              ...
              contextOptions = __assign({
                logging: (_e = opts.logging) !== null && _e !== undefined ? _e : true,
                cache: opts.cache
              }, resourceOptions);
              windowOptions = {

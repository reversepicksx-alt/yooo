    ...
    >
      ...
      {step === 1 ? (
        <div style={{ width: "100%", maxWidth: 320, display: "flex", flexDirection: "column", gap: 16 }}>
          <div style={{ fontSize: 18, fontWeight: 800, color: C.text, marginBottom: 4 }}>Welcome Back</div>
          <div style={{ fontSize: 13, color: C.text2, marginBottom: 8 }}>Enter your email to continue</div>
        ...
        <div style={{ width: "100%", maxWidth: 320, display: "flex", flexDirection: "column", gap: 16 }}>
          <div style={{ fontSize: 18, fontWeight: 800, color: C.text, marginBottom: 4 }}>Enter Password</div>

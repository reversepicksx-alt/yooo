...
Model projection and causal workload are separate decision layers. Causal workload must never replace or silently blend into the deterministic projection; when their directions oppose, expose a causal contradiction and a PASS with the conflict as the reason.

...
**How to apply:** Keep the interactive lookup bounded, query exact word boundaries separately, deduplicate by player/team/league context, then apply the existing ranking and quality filters.
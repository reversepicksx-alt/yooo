...
- Build b929d433: v1.15 #198 — compound-name player search fix, hit-rate strip below filter tabs, Analyze button always shown, optimistic delete, Face ID plugin aligned, expo-local-authentication SDK 54 aligned → FINISHED, submitted to TestFlight (submission 04355378)
